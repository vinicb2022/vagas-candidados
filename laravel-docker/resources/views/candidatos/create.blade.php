...
@section('content')
    ...
    <div class="col-md-10 m-auto">
        ...
        @endif
            ...
            <textarea class="form-control" name="formacao" id="formacao-academica" cols="4" rows="3" placeholder="Inserir formação acadêmica" value="{{$candidato->formacao_academica ?? ''}}" required></textarea>
            <textarea class="form-control" name="experiencia" id="experiencia-profissional" cols="4" rows="3" placeholder="Inserir experiência profissional" value="{{$candidato->experiencia_profissional ?? ''}}" required></textarea>
            <textarea class="form-control" name="habilidades" id="habilidades-especificas" cols="4" rows="3" placeholder="Inserir habilidades específicas" value="{{$candidato->habilidades_especificas ?? ''}}" required></textarea>
